...
class WGAN():
    ...
    def train(self):
        ...
        for epoch in range(0, self.epochs):
            ...
            if ((epoch + 1) % 10 == 0 and self.lr > 1e-8):
    ...
    def test(self, epoch):
        ...
        for i in range(1, 20, 2):
            self.compute_quality(i)
        self.save_loss((vgg_loss, mse_loss, g_loss, d_loss))
        self.save_model()

    def compute_quality(self, level):
        psnr1 = 0
        psnr2 = 0
        mse1 = 0
        mse2 = 0
        ...
        for i in range(101, 111):
            ...
            noised_nii = nib.load(
                "./data/dataset/noise_%d/%d.nii" % (level, i))
        ...
        print("Level: %d, psnr: %f,%f,ssim: %f,%f,mse:%f,%f" %
              (level, _psnr1, _psnr2, _ssim1, _ssim2, _mse1, _mse2))
